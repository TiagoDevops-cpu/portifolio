...
export const SKILLS_LIST: Skill[] = [
	{
		...
		level: 98,
		description:
			"Semântica moderna, layouts responsivos, animações e estilização ultrarrápida com Tailwind CSS.",
	},
	{
		id: "javascript",
		name: "JavaScript (ES6+)",
		...
		level: 95,
		description:
			"Lógica avançada, manipulação assíncrona do DOM, consumo de APIs e integração dinâmica.",
	},
	{
		id: "react",
		...
		level: 92,
		description:
			"Criação de Single Page Applications (SPAs) reativas, componentes reutilizáveis e páginas SSR focadas em SEO.",
	},
	{
		id: "typescript",
		name: "TypeScript",
		...
		level: 90,
		description:
			"Código fortemente tipado, prevenindo erros em tempo de compilação e aumentando a previsibilidade do projeto.",
	},
	{
		id: "node",
		...
		level: 88,
		description:
			"Desenvolvimento de APIs RESTful robustas, autenticação, rotas rápidas e integração com bancos de dados.",
	},
	{
		id: "db",
		...
		level: 85,
		description:
			"Modelagem e gerenciamento de dados com PostgreSQL, MongoDB e Firebase Firestore.",
	},
	{
		id: "figma",
		...
		level: 94,
		description:
			"Prototipagem de interfaces elegantes, wireframes, Design Systems e foco na usabilidade do cliente final.",
	},
	{
		id: "performance",
		...
		level: 96,
		description:
			"Otimização de Core Web Vitals, imagens leves, carregamento instantâneo e ranqueamento no Google.",
	},
	{
		id: "git",
		...
		level: 90,
		description:
			"Controle de versão com GitHub, automação de deploys na Vercel/Netlify/Cloud Run e rotinas de CI/CD.",
	},
];
...
export const PROJECTS_LIST: Project[] = [
	{
		...
		description:
			"Desenvolvimento de site corporativo completo para empresa multinacional de logística. Inclui rastreamento de cargas em tempo real, painel de cotações dinâmico e integração com WhatsApp comercial.",
		image:
	...
	},
	{
		...
		description:
			"Loja virtual moderna e minimalista para marca de joias finas. Conta com catálogo interativo de produtos, carrinho de compras dinâmico, checkout simplificado via WhatsApp e PIX.",
		image:
	...
	},
	{
		...
		clientType: "Pequeno/Médio Negócio",
		description:
			"Landing Page focada em conversão direta para clínica odontológica de alto padrão. Projetada para campanhas de Google Ads com botão flutuante de agendamento no WhatsApp.",
		image:
	...
	},
	{
		...
		clientType: "Empresa de Grande Porte",
		description:
			"Plataforma web para gestão de alunos, planos de treino e controle financeiro. Interface escura no estilo cyberpunk moderno com gráficos interativos e relatórios em tempo real.",
		image:
	...
	},
	{
		...
		clientType: "Empresa de Grande Porte",
		description:
			"Site para construtora exibindo portfólio de obras concluídas, plantas de novos lançamentos em 3D e simulador de financiamento simplificado.",
		image:
	...
	},
	{
		...
		clientType: "Pequeno/Médio Negócio",
		description:
			"Site responsivo para restaurante de gastronomia artesanal. Acompanha cardápio interativo online acessível via QR Code nas mesas e sistema de pedidos diretos no WhatsApp.",
		image:
...
export const SERVICES_PACKAGES: ServicePackage[] = [
	{
		...
		subtitle:
			"Sua empresa com presença digital marcante, credibilidade e visual moderno.",
		...
		icon: "Building2",
		recommendedFor:
			"Empresas que desejam transmitir confiança e atrair novos parceiros comerciais.",
	},
	{
		id: "landing-pages",
		title: "Landing Pages de Alta Conversão",
		subtitle:
			"Páginas projetadas para transformar tráfego em vendas e novos leads.",
		...
		icon: "Target",
		recommendedFor:
			"Quem investe em anúncios (Google Ads, Facebook Ads) e quer resultados imediatos.",
	},
	{
		id: "e-commerce",
		title: "Lojas Virtuais & E-Commerce",
		subtitle:
			"Venda seus produtos 24 horas por dia com uma plataforma rápida e intuitiva.",
		...
		icon: "ShoppingBag",
		recommendedFor:
			"Lojistas que buscam expandir suas vendas físicas para todo o Brasil.",
	},
	{
		id: "sistemas-web",
		title: "Sistemas Web & Aplicações Sob Medida",
		subtitle:
			"Desenvolvimento de dashboards, portais de clientes e automações internas.",
		targetAudience:
			"Empresas com processos específicos que exigem sistemas próprios",
		deliverables: [
		...
		recommendedFor:
			"Negócios que precisam automatizar rotinas e organizar operações complexas.",
	},
];
...
export const STATS_LIST = [
	{
		value: "100%",
		label: "Projetos Responsivos",
		detail: "Perfeito em qualquer tela",
	},
	{
		value: "95+",
		label: "Google PageSpeed",
		detail: "Carregamento instantâneo",
	},
	{
		value: "24h",
		label: "WhatsApp Direto",
		detail: "Atendimento sem intermediários",
	},
	{
		value: "Full-Stack",
		label: "Especialização Total",
		detail: "Do Design ao Servidor",
	},
];
